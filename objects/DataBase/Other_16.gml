...
shop[Weapon.Pistol2, ShopKey.Price] = 900;
...
shop[Weapon.Rifle2, ShopKey.Price] = 1200;
...
shop[Weapon.Shotgun2, ShopKey.Price] = 1200;
...
shop[Weapon.Pistol3, ShopKey.Price] = 1700;
...
shop[Weapon.Rocket, ShopKey.Price] = 2800;
...
shop[Weapon.Tesla, ShopKey.Price] = 3100;
...
shop[Weapon.Acid, ShopKey.Price] = 3400;
...
shop[Weapon.Knife4, ShopKey.Price] = 3700;
...
shop[GrenadeType.Incendiary, ShopKey.Description] = "Damage: Impact-2 Explosion-2\nGround Fire Ignite Chance 66%\nFuse Time: 0 seconds\nPenetration: 3\nExplosion Size: Small";
